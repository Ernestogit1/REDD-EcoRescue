...
const MOCK_GAMES = [
  ...
  },
  {
    ...
    id: 2,
    title: 'Swamp Quest',
    description: 'Solve swamp-themed jigsaw puzzles and learn about wildlife conservation',
    fullDescription: 'Challenge your problem-solving skills with our Swamp Quest Game! Complete beautiful jigsaw puzzles featuring swamp wildlife and landscapes. Choose from three difficulty levels: Easy (2x2), Medium (3x3), and Hard (4x2). Each completed puzzle teaches you about swamp ecosystems and wildlife conservation.',
    ...
    duration: '20-45 min',
    ageRange: '8-16 years',
    image: '/image/swamp.jpg',
    banner: '/image/puz.png',
    features: [
      'Multiple difficulty levels',
  ...
  },
  {
    ...
    id: 3,
    title: 'Beach Match',
    description: 'Test your knowledge by matching sea animals and their sounds',
    fullDescription: 'Challenge your wildlife knowledge with our Beach Match Game! Listen to animal sounds and match them with the correct sea animals. Learn about different species, their habitats, and the sounds they make in the wild. Perfect for developing auditory recognition skills while learning about marine ecosystems.',
  ...
  },
  {
    ...
    description: 'Let your imagination run wild! into the blazing snow!!!',
